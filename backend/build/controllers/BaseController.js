...
var BaseController = /** @class */ (function () {
    function BaseController(req, res, action) {
        this.req = req;
        this.res = res;
        this.action = action;
    }
    BaseController.prototype.getHeader = function (header) {
        var h = this.req.header(header);
        return Array.isArray(h) ? h[0] : h || "";
    };
    BaseController.prototype.getQueryParam = function (param) {
        var p = this.req.query[param];
        return p;
    };
