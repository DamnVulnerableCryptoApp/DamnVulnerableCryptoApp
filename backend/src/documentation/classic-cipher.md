...
Classic ciphers were built before the appearance of computers and therefore were based on letters or symbols instead of bits. In contrast to modern cryptography, there wasn't the computational power to compute messages with strong ciphers resulting in all of them being crafted by hand. 
